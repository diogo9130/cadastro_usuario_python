print(
    ...
    ' Onde f é feminino e m é masculino\n5º - O estado civil deve ser s, c, v ou d. Onde, s é solteiro, c casado, v viúvo e d divorciado')
nome = input('\n\nNome: ')
if len(nome) < 3:
    while len(nome) < 3:
        print('Nome inválido.')
...
if escolha == "c":
    ...
    if escolha_2 == "s":
        while escolha_2 == "s":
            ...
            elif escolha_2 != "s" or escolha_2 != "n":
                escolha_3 = ("s", "n")
                while escolha_2 not in escolha_3:
